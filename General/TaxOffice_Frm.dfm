inherited TaxOfficeFrm: TTaxOfficeFrm
  BorderIcons = []
  BorderStyle = bsNone
  Caption = 'TaxOfficeFrm'
  ClientHeight = 745
  ClientWidth = 968
  PixelsPerInch = 96
  TextHeight = 13
  inherited layMain: TdxLayoutControl
    ...
    inherited grdMaster: TcxGrid
      ...
      inherited viewMaster: TcxGridDBBandedTableView
        DataController.DataSource = MTDM.dtsTaxOffice
        OptionsCustomize.ColumnsQuickCustomization = True
        OptionsView.NoDataToDisplayInfoText = '<No Tax Office data to display>'
        OptionsView.ColumnAutoWidth = True
        Bands = <
          item
            Caption = 'Tax Office Listing'
          end>
