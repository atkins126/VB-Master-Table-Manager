  ...
  case AButtonIndex of
    ...
    16, 17, 18, 19:
      begin
        ...
        try
          ReportTypeName := 'Standard Activity Listing';
          case AButtonIndex of
            16, 17:
              begin
                ...
                ReportDM.PrepareReport(MTDM.cdsStdActivity, ReportDM.cdsStdActivity, RepFileName, Report, ReportDataSet, ReportTypeName);
