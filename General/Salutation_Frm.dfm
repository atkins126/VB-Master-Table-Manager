inherited SalutationFrm: TSalutationFrm
  BorderIcons = []
  BorderStyle = bsNone
  ...
  inherited layMain: TdxLayoutControl
    ...
    inherited grdMaster: TcxGrid
      ...
      inherited viewMaster: TcxGridDBBandedTableView
        DataController.DataSource = MTDM.dtsSalutation
        OptionsCustomize.ColumnsQuickCustomization = True
        OptionsView.NoDataToDisplayInfoText = '<No Salutation data to display>'
        OptionsView.ColumnAutoWidth = True
        Bands = <
          item
            Caption = 'Salutation Listing'
          end>
