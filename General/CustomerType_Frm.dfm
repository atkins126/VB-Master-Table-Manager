inherited CustomerTypeFrm: TCustomerTypeFrm
  BorderIcons = []
  BorderStyle = bsNone
  Caption = 'CustomerTypeFrm'
  ClientHeight = 745
  ClientWidth = 968
  PixelsPerInch = 96
  TextHeight = 13
  inherited layMain: TdxLayoutControl
    ...
    inherited grdMaster: TcxGrid
      ...
      inherited viewMaster: TcxGridDBBandedTableView
        DataController.DataSource = MTDM.dtsCustomerType
        OptionsCustomize.ColumnsQuickCustomization = True
        OptionsView.NoDataToDisplayInfoText = '<No Customer Type data to display>'
        OptionsView.ColumnAutoWidth = True
        Bands = <
          item
            Caption = 'Customer Type Listing'
          end>
