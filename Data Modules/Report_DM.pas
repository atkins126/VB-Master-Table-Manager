...
type
  ...
  TReportDM = class(TBaseDM)
    ...
    cdsCustomerSelect: TFDMemTable;
    dtsCustomerSelect: TDataSource;
    cdsCustomerSelectID: TIntegerField;
    cdsCustomerSelectCUSTOMER_TYPE_ID: TIntegerField;
    cdsCustomerSelectYEAR_END_MONTH_ID: TIntegerField;
    cdsCustomerSelectTAX_OFFICE_ID: TIntegerField;
    cdsCustomerSelectVAT_MONTH_ID: TIntegerField;
    cdsCustomerSelectVAT_COUNTRY_ID: TIntegerField;
    cdsCustomerSelectVAT_OFFICE_ID: TIntegerField;
    cdsCustomerSelectAR_MONTH_ID: TIntegerField;
    cdsCustomerSelectSTATUS_ID: TIntegerField;
    cdsCustomerSelectNAME: TStringField;
    cdsCustomerSelectFIRST_NAME: TStringField;
    cdsCustomerSelectLAST_NAME: TStringField;
    cdsCustomerSelectINITIALS: TStringField;
    cdsCustomerSelectTRADING_AS: TStringField;
    cdsCustomerSelectBILL_TO: TStringField;
    cdsCustomerSelectCO_NO: TStringField;
    cdsCustomerSelectTAX_NO: TStringField;
    cdsCustomerSelectVAT_NO: TStringField;
    cdsCustomerSelectVAT_CUSTOMS_CODE: TStringField;
    cdsCustomerSelectPAYE_UIF_NO: TStringField;
    cdsCustomerSelectSDL_NO: TStringField;
    cdsCustomerSelectWC_NO: TStringField;
    cdsCustomerSelectAR_COMPLETION_DATE: TSQLTimeStampField;
    cdsCustomerSelectSARS_AUTHORIZATION_SHEET: TStringField;
    cdsCustomerSelectPASTEL_ACC_CODE: TStringField;
    cdsCustomerSelectVB_TAX_ACC_CODE: TStringField;
    cdsCustomerSelectIS_PROV_TAX_PAYER: TIntegerField;
    cdsCustomerSelectHAS_LIVING_WILL: TIntegerField;
    cdsCustomerSelectIS_ORGAN_DONOR: TIntegerField;
    cdsCustomerSelectDATE_CREATED: TSQLTimeStampField;
    cdsCustomerSelectDATE_MODIFIED: TSQLTimeStampField;
    cdsCustomerSelectIS_ACTIVE: TIntegerField;
    cdsCustomerSelectEFILING: TStringField;
    cdsCustomerSelectEF_USER_NAME: TStringField;
    cdsCustomerSelectEF_PASSWORD: TStringField;
    cdsCustomerSelectCUSTOMER_GROUP_ID: TIntegerField;
